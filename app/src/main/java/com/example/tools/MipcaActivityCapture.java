...
public class MipcaActivityCapture extends Activity implements Callback , View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.qrcode_scan_core);
        //ViewUtil.addTopView(getApplicationContext(), this, R.string.scan_card);
        if (ContextCompat.checkSelfPermission(MipcaActivityCapture.this, android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(MipcaActivityCapture.this, new String[]{ android.Manifest.permission.CAMERA }, 1);
        }
